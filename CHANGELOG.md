...
## [0.8.4](https://github.com/gubasso/release-kit/compare/v0.8.3...v0.8.4) - 2026-09-17

### Fixed

- *(integration)* read every page of release requests with a filter the forge CLI accepts
- *(setup/protection)* keep the trunk's unbypassable rules out of the bypassed ruleset
- *(integration)* preserve release request freshness

## [0.8.3](https://github.com/gubasso/release-kit/compare/v0.8.2...v0.8.3) - 2026-09-16

### Added

- *(integration)* hold the release request where the trunk cannot hold it

## [0.8.2](https://github.com/gubasso/release-kit/compare/v0.8.1...v0.8.2) - 2026-09-15

### Fixed

- *(landing)* correct the landed text and pins that outlived the answers they describe

## [0.8.1](https://github.com/gubasso/release-kit/compare/v0.8.0...v0.8.1) - 2026-09-15

### Fixed

- *(landing/code-scanning)* read a conjunction of code and content terms as an open-source codebase

## [0.8.0](https://github.com/gubasso/release-kit/compare/v0.7.1...v0.8.0) - 2026-09-15

### Added

- *(integrate)* [**breaking**] make the authority that carries an implementation onto the trunk a recorded answer ([#232](https://github.com/gubasso/release-kit/pull/232))
...
- *(target-config)* [**breaking**] type the target configuration by domain and derive every landing from it ([#229](https://github.com/gubasso/release-kit/pull/229))
...
- *(rk-setup)* ask how a target with no manager obtains rk before the landing closes ([#225](https://github.com/gubasso/release-kit/pull/225))
- *(rk-setup)* offer the freshness wire where a target's pin has nothing moving it ([#223](https://github.com/gubasso/release-kit/pull/223))

## [0.6.0](https://github.com/gubasso/release-kit/compare/v0.5.0...v0.6.0) - 2026-09-14

### Other

- *(distribution)* [**breaking**] remove cross-release bundles and stored reconciliation

## [0.5.0](https://github.com/gubasso/release-kit/compare/v0.4.0...v0.5.0) - 2026-09-14

### Added

- *(landing)* [**breaking**] land every front directly from the installed binary's projection
- *(stage)* stage the candidate an agent studies and clean it on request
- *(distribution)* [**breaking**] support x86_64 linux as the only release and landed target

### Other

- *(skills/setup)* make the setup skill own the migration from the installed binary's stage
- *(landing)* project the candidate tree from the embedded sources through one pure boundary
...
- *(reconcile)* bind the target, verify every byte, and hold the target alone ([#188](https://github.com/gubasso/release-kit/pull/188))
...
- *(method/reconcile)* own the plan, decide, apply lifecycle in one chapter and runbook ([#181](https://github.com/gubasso/release-kit/pull/181))

## [0.3.26](https://github.com/gubasso/release-kit/compare/v0.3.25...v0.3.26) - 2026-09-12

### Added

- *(reconcile/compatibility)* ship compatibility and guidance in the bundle ([#179](https://github.com/gubasso/release-kit/pull/179))

## [0.3.25](https://github.com/gubasso/release-kit/compare/v0.3.24...v0.3.25) - 2026-09-12

### Added

- *(reconcile/apply)* apply only a stored plan ([#177](https://github.com/gubasso/release-kit/pull/177))

## [0.3.24](https://github.com/gubasso/release-kit/compare/v0.3.23...v0.3.24) - 2026-09-12

### Added

- *(reconcile/plan)* plan every landing write as one typed document ([#175](https://github.com/gubasso/release-kit/pull/175))

## [0.3.23](https://github.com/gubasso/release-kit/compare/v0.3.22...v0.3.23) - 2026-09-12

### Other

- *(payload/source)* read every release through one seam ([#173](https://github.com/gubasso/release-kit/pull/173))

## [0.3.22](https://github.com/gubasso/release-kit/compare/v0.3.21...v0.3.22) - 2026-09-12

### Added

- *(self-depend/venues)* cross the venue and the manager in one matrix ([#171](https://github.com/gubasso/release-kit/pull/171))

## [0.3.21](https://github.com/gubasso/release-kit/compare/v0.3.20...v0.3.21) - 2026-09-12

### Added

- *(self-depend/managers)* read the rk pin through a manager axis ([#169](https://github.com/gubasso/release-kit/pull/169))
...
- *(lints)* state the test exemption once and give every suppression its reason ([#159](https://github.com/gubasso/release-kit/pull/159))
...
- *(setup/protection)* make the three ruleset names and the title check the project's own ([#153](https://github.com/gubasso/release-kit/pull/153))
- *(setup/facts)* commit the four setup facts a target kept retyping ([#151](https://github.com/gubasso/release-kit/pull/151))
...
- *(method)* give the repair figure its measured clock ([#141](https://github.com/gubasso/release-kit/pull/141))

## [0.3.10](https://github.com/gubasso/release-kit/compare/v0.3.9...v0.3.10) - 2026-09-09

### Other

- *(method)* correct the freshness cost and the refusal an operator reads ([#138](https://github.com/gubasso/release-kit/pull/138))

## [0.3.9](https://github.com/gubasso/release-kit/compare/v0.3.8...v0.3.9) - 2026-09-09

### Added

- *(setup)* require a request to carry the trunk's tip before it merges ([#134](https://github.com/gubasso/release-kit/pull/134))
...
- *(snippets)* pin the rust release-plz tag name to the protected shape ([#124](https://github.com/gubasso/release-kit/pull/124))
...
- *(landing)* prompt an upgrade from what it would change ([#111](https://github.com/gubasso/release-kit/pull/111))
...
- *(landing)* [**breaking**] hold the commit scope by shape and not by vocabulary ([#95](https://github.com/gubasso/release-kit/pull/95))

## [0.2.23](https://github.com/gubasso/release-kit/compare/v0.2.22...v0.2.23) - 2026-09-07

### Fixed

- *(landing)* render the routing block in plain sentences ([#92](https://github.com/gubasso/release-kit/pull/92))
...
- *(cli)* add rk assess and the migration chapter ([#69](https://github.com/gubasso/release-kit/pull/69))
...
- *(landing)* land the nix capability as a recorded opt-in ([#55](https://github.com/gubasso/release-kit/pull/55))

## [0.2.14](https://github.com/gubasso/release-kit/compare/v0.2.13...v0.2.14) - 2026-09-04

### Other

- *(distribution)* bind user-scope skills and per-project placement ([#53](https://github.com/gubasso/release-kit/pull/53))
...
- *(instance)* record the trunk style and take the landing to 0.2.11 ([#48](https://github.com/gubasso/release-kit/pull/48))
...
- *(landing)* record the release style, arm the trunk request, and support release lines ([#43](https://github.com/gubasso/release-kit/pull/43))

## [0.2.9](https://github.com/gubasso/release-kit/compare/v0.2.8...v0.2.9) - 2026-09-02

### Added

- *(distribution)* probe the installed skills and gate on the host ([#41](https://github.com/gubasso/release-kit/pull/41))

## [0.2.8](https://github.com/gubasso/release-kit/compare/v0.2.7...v0.2.8) - 2026-09-02

### Added

- *(cli)* separate a worktree's project and branch with @ ([#37](https://github.com/gubasso/release-kit/pull/37))

### Other

- *(method)* state the worktree layouts the sibling rule admits ([#39](https://github.com/gubasso/release-kit/pull/39))
...
- *(instance)* Land this repository in worktree mode ([#31](https://github.com/gubasso/release-kit/pull/31))

## [0.2.5](https://github.com/gubasso/release-kit/compare/v0.2.4...v0.2.5) - 2026-09-02

### Fixed

- *(landing)* Render the worktree guard as valid YAML and act on the named target from hooks ([#29](https://github.com/gubasso/release-kit/pull/29))

## [0.2.4](https://github.com/gubasso/release-kit/compare/v0.2.3...v0.2.4) - 2026-09-02

### Added

- *(cli)* Land the worktree workflow ([#27](https://github.com/gubasso/release-kit/pull/27))
...
- *(landing)* Bound the agent's initiative in the routing block ([#17](https://github.com/gubasso/release-kit/pull/17))

## [0.2.1](https://github.com/gubasso/release-kit/compare/v0.2.0...v0.2.1) - 2026-09-01

### Fixed

- *(landing)* Keep the commit-time branch guard out of CI sweeps ([#13](https://github.com/gubasso/release-kit/pull/13))

## [0.2.0](https://github.com/gubasso/release-kit/compare/v0.1.0...v0.2.0) - 2026-09-01

### Added

- *(landing)* [**breaking**] land the commit contract and its local mirrors
- *(setup)* Delete every branch its merge retires ([#5](https://github.com/gubasso/release-kit/pull/5))

### Fixed

- *(landing)* close the review findings on the commit contract
