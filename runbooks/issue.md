...
- The clone's origin is a GitHub host other than github.com. This verb reaches github.com alone. Start the branch with `gh issue develop --repo <host>/<owner>/<name>`, then `rk worktree add` it.
