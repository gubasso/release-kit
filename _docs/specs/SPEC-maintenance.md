...
- GIVEN a branch integrated locally at commit A whose tip then moved to B
- WHEN `rk branches prune --apply` runs
- THEN the evidence records A, the tip is B, no proof covers B, and the branch stays
