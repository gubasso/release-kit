...
The decision is asked rather than assumed. A pin with nothing moving it is the state this chapter exists to prevent, and a setup that never raises the question reaches it through the supported path. So a setup asks, and it records the answer: a refusal is a decision the project made, never a step nobody reached.
