...
Two protections owned by every repository, a merge-permission switch beside them, and a third protection where older lines exist, all held by configuration that a script can verify:
