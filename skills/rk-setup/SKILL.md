...
- Never widen an approved scope inline: a mode or style change, a second branch, a workspace move is its own plan, and a gap the stage reports that the inventory does not name returns to planning first.
